    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, priority = _req$body.priority, description = _req$body.description, deliverydate = _req$body.deliverydate; // console.log(req.body);
...
function editProject(_x7, _x8) {
  return _editProject.apply(this, arguments);
}

function _editProject() {
  _editProject = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(req, res) {
    var id, _req$body2, name, priority, description, deliverydate, oldProject;
          ...
          case 5:
            ...
            if (oldProject.length > 0) {
              ...
              function () {
                ...
                /*#__PURE__*/
                regeneratorRuntime.mark(function _callee4(project) {
